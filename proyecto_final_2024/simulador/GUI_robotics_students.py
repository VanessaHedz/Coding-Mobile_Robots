...
#Banderas para aparecer/desaparecer los bloques
flgA= 0
flgB= 0
flgC= 0
flgD= 0
...
# ---------------------------------------------------------------- GRAFICA LETRAS ----!
	...
	# COORDS STUDIO: 0.43,0.53
	StudioX = ( DIM_CANVAS_X * 0.43 ) / dim_x
	StudioY = DIM_CANVAS_Y - ( DIM_CANVAS_Y * 0.53 ) / dim_y
	# COORDS CORRIDOR: 0.6,1.0
	CorridorX = ( DIM_CANVAS_X * 0.6 ) / dim_x
	CorridorY = DIM_CANVAS_Y - ( DIM_CANVAS_Y * 1 ) / dim_y
	# COORDS BEDROOM
	BedroomX = ( DIM_CANVAS_X * 1.05 ) / dim_x
	BedroomY = DIM_CANVAS_Y - ( DIM_CANVAS_Y * 0.555 ) / dim_y
	# COORDS SERVICE
	ServiceX = ( DIM_CANVAS_X * 1.62 ) / dim_x
	ServiceY = DIM_CANVAS_Y - ( DIM_CANVAS_Y * 0.54 ) / dim_y
	# COORDS KITCHEN
	KitchenX = ( DIM_CANVAS_X * 1.58 ) / dim_x
	KitchenY = DIM_CANVAS_Y - ( DIM_CANVAS_Y * 1.405 ) / dim_y
	# COORDS DEPOSIT
	DepositX = ( DIM_CANVAS_X * 0.7 ) / dim_x
	DepositY = DIM_CANVAS_Y - ( DIM_CANVAS_Y * 1.51 ) / dim_y
